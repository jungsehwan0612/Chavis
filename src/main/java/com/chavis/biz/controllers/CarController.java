...
public class CarController {
	...
	public int updateTireDistance(@RequestParam("distance") String distance, @RequestParam("car_no") int car_no) {
		return service.updateTireDistance(distance, car_no);
	}

	@RequestMapping("/Car/updateWiperDistance.do")
	public int updateWiperDistance(@RequestParam("distance") String distance, @RequestParam("car_no") int car_no) {
	...
	public int updateEngineOil(@RequestParam("engineOil") String engineOil, @RequestParam("car_no") int car_no) {
		return service.updateEngineOil(engineOil, car_no);
	}

	@RequestMapping("/Car/updateDistance.do")
	public int updateDistance(@RequestParam("distance") String distance, @RequestParam("car_no") int car_no) {
